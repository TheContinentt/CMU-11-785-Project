...
class Preprocessing:
    def __init__(self, num_words, seq_len, file_path):
    ...
    def load_data(self):
        ...
        df = pd.read_csv(self.data, sep=';', names=['id', 'target', 'Text'],encoding = "ISO-8859-1")
        # df.drop(['id', 'keyword', 'location'], axis=1, inplace=True)
        self.x_raw = df['Text'].values
        print('self_x_raw = ', self.x_raw)
    ...
    def clean_text(self):
        ...
        self.x_raw = [re.sub(r'[^A-Za-z]+', ' ', str(x)) for x in self.x_raw]
