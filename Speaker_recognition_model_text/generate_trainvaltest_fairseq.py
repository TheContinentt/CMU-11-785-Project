...
train_out = './knnw/train_full_fair.txt'
val_out = './knnw/val_full_fair.txt'
test_out = './knnw/test_full_fair.txt'

csv_file = './knnw/knnw_en_sub_fairseq.csv'
...
with open(val_in, 'r') as train_in_f:
    with open(val_out, 'w') as train_out_f:
