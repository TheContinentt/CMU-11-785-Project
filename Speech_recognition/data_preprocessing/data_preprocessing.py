...
def write_tsv(file_name, index_list):
    ...
    with open(file_name, "w") as f:
        print('~/yourpath/', file=f)

        for index in index_list:
            wav_path = 'data/'+str(index)+'.wav'
            wav_full_path = '~/yourpath/data/'+str(index)+'.wav'
...
csv_file = '~/yourpath/knnw/knnw_en_sub.csv'
wav_file = '~/yourpath/knnw/knnw_en_mono.wav'
trans_file = '~/yourpath/trans.txt'
...
with open(csv_file, mode='r') as f, open(trans_file, mode='w') as trans_f:
    ...
    for row in csv_reader:
        ...
        wav_file = '~/yourpath/data/'+str(id)+'.wav'
...
train_file = '~/yourpath/train.txt'
val_file = '~/yourpath/val.txt'
test_file = '~/yourpath/test.txt'

train_idx = read_txt(train_file)
val_idx = read_txt(val_file)
test_idx = read_txt(test_file)

train_tsv = '~/yourpath/train.tsv'
val_tsv = '~/yourpath/valid.tsv'
test_tsv = '~/yourpath/test.tsv'
